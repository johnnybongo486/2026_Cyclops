...
public class PoseLimelight extends SubsystemBase {
   ...
   private double blueLLRightLeft = -0.3002;  // -0.3302 // .4802
   private double blueLLRightRight = 0.3002; // 0.3302
   ...
   private double redLLRightLeft = 0.3002;  // 0.3302
   private double redLLRightRight = -0.3002;  //-0.3302
